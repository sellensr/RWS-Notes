...
void setup() {
  ...
  pinMode(12,INPUT_PULLUP);     // use pin 10 for input from the button
...
void loop() {
  ...
  timeNow = micros();
  but = digitalRead(12);      // the button should be connected to pin 10
  ...
  Serial.print(but);
  Serial.print(" digitalRead on pin 12, ");
  Serial.print(pht);
